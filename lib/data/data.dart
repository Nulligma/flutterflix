...
import 'package:flutterflix/data/trailers.dart';
...
final NotificationData notification1 = NotificationData(
    Assets.atla_landscape, "Avatar: New season now live", atla);

final NotificationData notification2 = NotificationData(
    Assets.shazam_landscape, "Shazam: New DC movie just released", shazam);

final NotificationData notification3 = NotificationData(
    Assets.umbrellaAcademyLandscape,
    "Recomemded for you: Umbrella Academy",
    umbrellaAcademy);

final NotificationData notification4 = NotificationData(
    Assets.matrix_landscape, "Recomemded for you: Matrix", matrix);

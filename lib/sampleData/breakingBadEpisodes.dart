...
final Episode breakingBadEpisode1 = Episode(
    number: 1,
    name: "The National Anthem",
    seasonName: "Season 1",
    imageUrl: Assets.breakingBad_ep1,
    summary:
...
final Episode breakingBadEpisode2 = Episode(
    number: 2,
    name: "Fifteen Million Merits",
    seasonName: "Season 1",
    imageUrl: Assets.breakingBad_ep2,
    summary:
...
final Episode breakingBadEpisode3 = Episode(
    number: 3,
    name: "The Entire History of You",
    seasonName: "Season 2",
    imageUrl: Assets.breakingBad_ep3,
    summary:
